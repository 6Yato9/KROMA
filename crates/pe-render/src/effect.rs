...
fn effect_source(name: &str) -> &'static str {
    match name {
        ...
        "sharpen" => include_str!("../../../shaders/effects/sharpen.wgsl"),
        "sharpen_edges" => include_str!("../../../shaders/effects/sharpen_edges.wgsl"),
        "soften_sharpen" => include_str!("../../../shaders/effects/soften_sharpen.wgsl"),
        "lens_distortion" => include_str!("../../../shaders/effects/lens_distortion.wgsl"),
        "dirt_removal" => include_str!("../../../shaders/effects/dirt_removal.wgsl"),
